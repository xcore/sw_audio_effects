...
Note After initialisation, config_loudness() can be called again as required to re-configure the gain.
...
If is occurs, try turning down the volume of the audio source. 
