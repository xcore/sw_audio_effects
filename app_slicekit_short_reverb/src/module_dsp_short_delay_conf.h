/******************************************************************************\
 * Header:  module_dsp_short_delay_conf
 * File:    module_dsp_short_delay_conf.h
 *
...
#ifndef _MODULE_DSP_SHORT_DELAY_CONF_H_
#define _MODULE_DSP_SHORT_DELAY_CONF_H_
