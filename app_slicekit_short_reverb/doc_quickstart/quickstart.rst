...
This is a demonstration of a complex audio application that uses a number of software modules and slice cards, 
to produce a short 'reverb-like' effect on an audio stream.
